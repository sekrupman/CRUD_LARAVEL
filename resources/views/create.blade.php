...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Username" name="username" require>
  </div>
  <div class="form-group">
  ...
  <a href="/" type="button" class="btn btn-warning">Back</button></a>
</form>
@if(session('error'))
